...
<script type="text/javascript">
    ...
    function listPemberkasanDua() {
        ...
        listPemberkasanDua.setHeader("No,No Berkas,NmrReg,No PID,Assignee,Status,Nama Penjual,Action,NmrNeg,Novism,NmrPbr,NmrByr");
        listPemberkasanDua.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPemberkasanDua.setInitWidths("40,166,166,166,166,166,166,100,0,0,0,0");
        listPemberkasanDua.setColAlign("left,left,left,left,left,left,left,left,left,left,left,left");
        listPemberkasanDua.setColTypes("ed,ed,ed,ed,ed,ed,ed,ch,ed,ed,ed,ed");
        listPemberkasanDua.attachEvent("onCheckbox", doOnCheck);
        listPemberkasanDua.init();
        listPemberkasanDua.setSkin("dhx_skyblue");

        listPemberkasanDua.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str");
    ...
    function doOnCheck(rowId, cellInd, state) {
        ...
        + "&param6=" + listPemberkasanDua.cells(rowId, 8).getValue()
        + "&param7=" + listPemberkasanDua.cells(rowId, 9).getValue()
        + "&param8=" + listPemberkasanDua.cells(rowId, 10).getValue()
        + "&param9=" + listPemberkasanDua.cells(rowId, 11).getValue()
        + "&param15=" 
        + "";
