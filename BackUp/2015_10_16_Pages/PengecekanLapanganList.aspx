...
<script type="text/javascript">
   ...
   // listPengecekanLapangan.loadXML("../xml/1_PengecekanLapangan.xml");
    function listPengecekanLapangan() {
        ...
        listPengecekanLapangan.setHeader("No,No Pengecekan,No Pra Registrasi,Nama Penjual,Desa,Status,Action,#cspan,#cspan");
        listPengecekanLapangan.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        ...
        listPengecekanLapangan.setColTypes("ed,ed,ed,ed,ed,ed,link,link,link");
