...
<h1>Negosiasi</h1>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-md-2">
            <asp:DropDownList ID="ddNegosiasi" runat="server" class="form-control input-lg" onclick="refresh()">
            </asp:DropDownList>            
            </div>
            <div class="col-sm-2">
           ...
           <div class="col-sm-1"></div>
            ...
            <div class="col-md-2">
                ...
                <asp:TextBox id="txtTglNeg" type="text" runat="server" class="form-control input-lg" />
            </div>
        </div>
    </div>
...
<div class="hidden"> <%--Di Hiden--%>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <label for="identitas" class="control-label col-lg-2">BANL</label>
...
<div role="form" class="form-horizontal" action="#">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <asp:TextBox ID="txttgl" class="form-control input-lg" runat="server" ></asp:TextBox>
        </div>
    ...
    <div class="form-group">
       ...
       <asp:DropDownList ID="ddobj" class="form-control input-lg" runat="server"></asp:DropDownList>
        ...
        <div class="col-sm-4">
            <asp:TextBox ID="txtluasd" class="form-control input-lg" runat="server" Enabled="True" onkeypress="return numbersonly(event, false)"></asp:TextBox>
       </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <asp:TextBox ID="txthrgpermin" class="form-control input-lg" runat="server" Enabled="True" onkeypress="return numbersonly(event, false)"></asp:TextBox>
        </div>
        ...
        <div class="col-sm-4">
            <asp:TextBox ID="txthrgpena" class="form-control input-lg" runat="server" Enabled="True" onkeypress="return numbersonly(event, false)"></asp:TextBox>
       </div>
   ...
   <div class="hidden"> <%--DI Hiden--%>
    <div class="form-group">
     ...
     <div class="form-group">
         ...
         <asp:Label ID="Label11" for="identitas"  class="control-label col-lg-2" runat="server" Text="Negosiasi Ke" Font-Bold="True"></asp:Label>
           <div class="col-sm-2">
           <asp:TextBox ID="txtNegKe" class="form-control input-lg" runat="server" Enabled="False"></asp:TextBox>
           </div>
           <div class="col-sm-2">
           <input type="button" id="btntambah" value="Tambah" runat="server" class="btn btn-lg btn-info" onclick="SaveKondisiNegq()" />
           </div>
<%--         <asp:Label ID="Label12" for="identitas"  class="control-label col-lg-2" runat="server" Text="No Squen" Font-Bold="True"></asp:Label>
           <div class="col-sm-4">
            <asp:TextBox ID="TextBox2" class="form-control input-lg" runat="server" Enabled="False"></asp:TextBox>
           </div>--%>
...
<div role="form" class="form-horizontal">
    <div class="form-group">
        <div class="col-lg-11" align="right">
            <input type="button" id="PopupbtnSaveNeg" value="Save" runat="server" class="btn btn-lg btn-success" onclick="SaveKondisiNeg()" />
        </div>
    </div>
</div>
</div>
