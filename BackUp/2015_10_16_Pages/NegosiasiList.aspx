...
//    listNegosiasi.loadXML("../xml/1_Negosiasi.xml");
    function listNegosiasi() {
        ...
        listNegosiasi.setHeader("No,No Negosiasi,No Registrasi,PID,Assigne,Status,Nama Penjual,Nama PLK,Priotiry,Action,#cspan,#cspan");
        listNegosiasi.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listNegosiasi.setInitWidths("40,103,103,103,103,113,156,156,103,50,50,50");
        listNegosiasi.setColAlign("left,left,left,left,left,left,left,left,left,left,left,left");
        listNegosiasi.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ed,link,link,link");
        listNegosiasi.init();
