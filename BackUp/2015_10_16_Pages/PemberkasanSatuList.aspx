...
<script type="text/javascript">
   ...
   // listPemberkasan.loadXML("../xml/1_Pemberkasan.xml");
    function listPemberkasan() {
        ...
        listPemberkasan.setHeader("No,No Berkas,No Registrasi,No PID,Assignee,Nama Penjual,Action,#cspan,#cspan");
        listPemberkasan.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listPemberkasan.setInitWidths("40,166,166,166,166,236,65,65,65");
        listPemberkasan.setColAlign("left,left,left,left,left,left,left,left,left");
        listPemberkasan.setColTypes("ed,ed,ed,ed,ed,ed,link,link,link");
