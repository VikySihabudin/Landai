...
<script type="text/javascript">
    ...
    function listPemberkasan() {
        ...
        listPemberkasan.setHeader("No,No Pemberkasan,No PID,No Registrasi,No Visum,Assignee,Status,Nama Penjual,Action,No Negosiasi");
        listPemberkasan.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPemberkasan.setInitWidths("40,140,140,140,140,140,140,170,85,0");
        listPemberkasan.setColAlign("left,left,left,left,left,left,left,left,left");
        listPemberkasan.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ch,ed");
    ...
    function doOnCheck(rowId, cellInd, state) {
        ...
        + "&param6=" + listPemberkasan.cells(rowId, 9).getValue() // No Registrasi
