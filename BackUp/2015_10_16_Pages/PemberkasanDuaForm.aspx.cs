...
public partial class Pages_PemberkasanDuaForm : System.Web.UI.Page
{
    ...
    private bool ServiceSelect(string sm)
    {
        ...
        switch (sm)
        {
            case "V":
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                ds = eSTP.List17("P_BERKS2", Param1, Param2, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
            ...
            case "DOCpic":
                ...
                dsx = eSTPx.List6("P_BERKS2_D", param1, IDFinal, "", "", "", "");
    ...
    private String Save()
    {
        ...
        try
        {
            ...
            if (output == "I" || output == "E" || output == "D")
            {
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                ds = eSTP.List17("P_BERKS2", "X", param2, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
                dt = ds.Tables[0];
            ...
            if (output == "I" || output == "E" || output == "D")
            {
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                eSTP.save17("P_BERKS2", param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17);
    ...
    private String SaveUploadFinal()
    {
        ...
        eSTP.save6("P_BERKS2_D", param1, IDFinal, "", "", param5, _stKeterangan);
