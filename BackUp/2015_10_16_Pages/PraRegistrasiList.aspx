...
<div class="form-group"> 
     <div class="col-lg-12" style=" width:100%; height:100%;">
           <div class="col-sm-2">
            ...
            { %> 
                <input type="button" onclick="tambah()" id="btnTambah" value="Tambah" class="btn btn-success btn-md" />
            <%}%>     
...
<script type="text/javascript">
    ...
    function listpraregistrasi() {
        ...
        listpraregistrasi.setHeader("No,No Pra Registrasi,No Identitas,Nama Penjual,Kabupaten,Kecamatan,Desa,Action,#cspan,#cspan");
        listpraregistrasi.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        ...
        listpraregistrasi.setColTypes("ed,ed,ed,ed,ed,ed,ed,link,link,link");
