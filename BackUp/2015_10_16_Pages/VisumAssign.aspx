...
<script type="text/javascript">
    ...
    function ListVisum() {
        ...
        ListVisum.setHeader("No,No Visum,No Registrasi,PID,Assigne,Status,Nama Penjual,Nama PLK,Action");
        ListVisum.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        ListVisum.setInitWidths("40,142,142,142,142,142,150,150,80");
        ListVisum.setColAlign("left,left,left,left,left,left,left,left,center");
        ListVisum.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ch");
