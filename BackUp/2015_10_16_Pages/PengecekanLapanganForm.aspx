...
<h1>Pengecekan Lapangan</h1>
	...
	<div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtNoPL" type="text" runat="server" class="form-control input-lg" /></div>			
            <label for="nama" class="control-label col-md-3">Tanggal Jadwal Pengecekan Lapangan</label>
            <div class="col-lg-3">
            <asp:TextBox id="txtTgljadwalPengukuran" type="text" runat="server" class="form-control input-lg" />
            </div>
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal Pengecekan Lapangan</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPengukuran" class="form-control input-lg" type="text" runat="server" /></div>			
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nomor PR</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoPR" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>			
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nama Penjual</label>
            <div class="col-lg-3"><asp:TextBox id="txtNamaPenjual" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>			
        </div>
    ...
    <div role="form" class="form-horizontal">
        <div id="shp" class="form-group">            
            ...
            <asp:Label ID="LLketerangan" for="identitas"  class="control-label col-lg-2" runat="server" Text="Keterangan" Font-Bold="True"></asp:Label>
    ...
    <%}%>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3">
                <asp:DropDownList ID="ddLanjut" runat="server" class="form-control input-lg"></asp:DropDownList>
            </div>
        </div>
        </div>
    ...
    <%}%>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtKeterangan" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
        </div>
