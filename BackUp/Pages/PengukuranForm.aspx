<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="PengukuranForm.aspx.cs" Inherits="Pages_Pengukuran" %>
...
<asp:Label ID="LIdent" runat="server" for="identitas" class="control-label col-lg-2"  Font-Bold="True"></asp:Label>
<br /><br /><br /><br />
<div class="container">
<h2>Pengukuran</h2><br />
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nomor PID</label>
            <div class="col-lg-3"><asp:TextBox id="txtPID" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
			<label for="identitas" class="control-label col-lg-3">Tanggal Penjadwalan Pengukuran</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPenPen" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nama Penjual</label>
            <div class="col-lg-3"><asp:TextBox id="txtNmPen" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal Registrasi</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglReg" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        ...
        <label for="identitas" class="control-label col-sm-2">Overlap</label>
            <div class="col-lg-5">    
                <div class="col-lg-3"><asp:CheckBox ID="cbOverLap" runat="server" CssClass="form-control checkbox-lg"  Text="" onclick="validasiOverlap()" /> </div>
            </div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
       ...
       <div class="col-lg-10">
        ...
        <div class="form-group">
            <div class="col-md-5">
                <input type="button" onclick="PopupGrid()" id="Button1" value="Tambah" class="btn btn-info btn-lg" />
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal Pengukuran</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPeng" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nama PLK</label>
            <div class="col-lg-3"><asp:TextBox id="txtNmPLK" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Luas PLK</label>
            <div class="col-lg-3"><asp:TextBox id="txtLsPLK" type="text" runat="server" class="form-control input-lg" placeholder= "..." onkeypress="return numbersonly(event, false)"/></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal GIFDUMP submit to LM</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglGIFDUMPtoLM" type="text" runat="server" Enabled="false" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal GIFDUMP submit to Survey</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglGIFDUMPtoSurvey" type="text" runat="server"  Enabled="false" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal PLK Approval Survey</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPLKApproveSurvey" type="text" runat="server"  Enabled="false" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal PLK Approval TS/HSE/RM</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPLKApproveTS" type="text" runat="server" Enabled="false" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal PLK Diterima LM</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPLKditerimaLM" type="text" runat="server"  Enabled="false" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <asp:Label  ID="LLanjut" runat="server"  for="identitas" class="control-label col-lg-2"  Text="Lanjut" Font-Bold="True"></asp:Label>
            <div class="col-lg-3"><asp:DropDownList ID="ddLanjut" runat="server" Enabled="False" class="form-control"></asp:DropDownList></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <asp:Label  ID="Label1" runat="server"  for="identitas" class="control-label col-lg-2" Text="Keterangan" Font-Bold="True"></asp:Label>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <asp:Label  ID="LEksepsi" runat="server"  for="identitas" class="control-label col-lg-2" Text="Eksepsi" Font-Bold="True"></asp:Label>
            <div class="col-lg-3">
            <asp:CheckBox ID="cbEksepsi" runat="server"  CssClass="form-control checkbox-lg" onclick="validasi()" /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <asp:Label ID="LKEksepsi" runat="server" for="identitas" class="control-label col-lg-2" Text="Keterangan Eksepsi" Font-Bold="True"></asp:Label>
            <div class="col-lg-3"><asp:TextBox id="txtKetEksepsi" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-3">Nama PLK</label>
            <div class="col-lg-4">
                <asp:TextBox ID="txtNamaPLK" class="form-control input-lg" runat="server"></asp:TextBox>
            </div>

            </div>
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-3">Luas PLK Overlap</label>
            <div class="col-lg-4">
                <asp:TextBox ID="txtLuasOverlap" class="form-control input-lg" runat="server" onkeypress="return numbersonly(event, false)"></asp:TextBox>
            </div>
            </div>
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-3">Status</label>
            <div class="col-lg-4">
                <asp:TextBox ID="txtStatus" class="form-control input-lg" runat="server"></asp:TextBox>
            </div>
        </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <div class="col-lg-11" align="right">
                <input type="button" id="PopupbtnSaveKondisiLahan" value="Save" runat="server" class="btn btn-lg btn-success" onclick="SaveOverlap()" />
            </div>
        </div>
    </div>
    </div>
...
<script type="text/javascript">
    ...
    function Edit(tipe) {
        if (ddLanjut.value == 1) {
            ...
            else if (txtNmPLK.value == '') {
                alert("Nama Plk Tidak Boleh Kosong");
                txtNmPLK.focus();
            }
            else if (txtLsPLK.value == '') {
