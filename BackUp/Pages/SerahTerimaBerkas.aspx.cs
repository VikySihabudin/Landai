        ...
        try
        {
            ...
            if (groups.ToString() != "1" )
            {
                if (output == "E")
                {
                    ...
                    eSTP.Datas();
                    DataSet ds = new DataSet();
                    ds = eSTP.select9("[landcomp].[P_SRHTRM]", "X", param2, param3, param4, param5, param6, userid, groups, param9);
                    dt = ds.Tables[0];
            ...
            if (output == "E" || output == "D" || output == "A" || output == "I")
            {
                ...
                eSTP.save9("[landcomp].[P_SRHTRM]", param1, param2, param3, userid, param5, param6, userid, groups, param9);
