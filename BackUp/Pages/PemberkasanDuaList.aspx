...
<script type="text/javascript">
    ...
    function listPemberkasanDua() {
        ...
        listPemberkasanDua.setHeader("No,No Berkas,No registrasi,No Pid,Assignee,Status,Action,#cspan,#cspan");
        listPemberkasanDua.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listPemberkasanDua.setInitWidths("40,175,175,170,170,170,78,78,78");
        listPemberkasanDua.setColAlign("left,left,left,left,left,left,left,left,left");
        listPemberkasanDua.setColTypes("ro,ro,ro,ro,ro,ro,link,link,link");
