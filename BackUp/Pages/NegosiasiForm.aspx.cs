...
public partial class Pages_NegosiasiForm : System.Web.UI.Page
{
    ...
    public void isiSepakat()
    {
        ...
        FROM landcomp.CODESS WHERE codessHeadss=6 AND codessStatss=1 ORDER BY codessCodess DESC";
     ...
     private String Save()
    {
           ...
           try
        {
            ...
            if (output == "I" ||  output == "E" || output == "D")
            {
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                eSTP.save13("P_NEGOSI", param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, userid, param13);
