...
<script type="text/javascript">
    ...
    function listPemberkasan() {
        ...
        listPemberkasan.setHeader("No,No Pemberkasan,No PID,No Registrasi,No Visum,Assignee,Status,Action,No Negosiasi");
    ...
    function doOnCheck(rowId, cellInd, state) {
        ...
        + "&param6=" + listPemberkasan.cells(rowId, 8).getValue() // No Registrasi
