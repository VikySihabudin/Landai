...
<h2>Visum</h2>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:DropDownList ID="ddLanjut" runat="server" class="form-control input-lg"></asp:DropDownList></div>
        </div>
    </div>
...
//      alert('a');
    ...
    function listVerifikasiDoc() {
        ...
        listVerifikasiDoc.setHeader("No,Kepastian Documents,Keterangan,Rekomendasi,Aksi,Squen");
        listVerifikasiDoc.setInitWidths("40,180,135,135,100,0");
