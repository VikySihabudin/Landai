...
<link href="../CSS/page.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
     ...
     function listTerimaBerkas() {
         ...
         listTerimaBerkas.setHeader("No,No Registrasi,Nama,Nomor Identitas,No Hp,Desa,Kecamatan,Kabupaten,Accept,Nomer Serah Terima");
         listTerimaBerkas.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
         listTerimaBerkas.setInitWidths("50,140,140,150,140,140,140,130,100,0");
         listTerimaBerkas.setColAlign("left,left,left,left,left,left,left,left,left,left");
         listTerimaBerkas.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ch,ro");
         listTerimaBerkas.attachEvent("onCheckbox", doOnCheck);
         listTerimaBerkas.init();
         listTerimaBerkas.setSkin("dhx_skyblue");

         listTerimaBerkas.setColSorting("str,str,str,str,str,str,str,str,str,str");
     ...
     function doOnCheck(rowId, cellInd, state) {
         ...
         if (state == 0) {
	        ...
	        + "&sm=CRUD"
	        + "&param1=E"
            + "&param2=" + listTerimaBerkas.cells(rowId, 9).getValue()
            + "";
