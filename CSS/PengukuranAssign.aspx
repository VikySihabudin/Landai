<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/mpBootstrap.master" AutoEventWireup="true" CodeFile="PengukuranAssign.aspx.cs" Inherits="Pages_PengukuranAssign" %>
...
<hr />
        ...
        <label for="identitas" class="control-label col-md-2">Date Awal</label>
        <div class="col-md-2"><asp:TextBox id="txtDateAwal" type="text" runat="server" class="form-control" /></div>
        <label for="identitas" class="control-label col-md-2">Date Akhir</label>
      ...
      <div class="form-group">
        ...
        <div class="col-md-1"><asp:Button runat="server" ID="btnSave" Text="Back" class="btn btn-lg btn-success" PostBackUrl="~/Pages/PengukuranList.aspx"/></div>    
      </div>
      ...
      <div class="form-group">      
        ...
        <div class="form-group">
            ...
            <div style=" width:100%; height:300px;">
                ...
                <div class="pagination" id="pagePengukuran"></div>  
            </div>
            </div>
        </div>
</div>
...
<script type="text/javascript">
    ...
    function listPengukuran() {
        ...
        listPengukuran.setHeader("No,PID,No Registrasi,Nama Pemilik,Kecamatan,Desa,Assign,Action,No Identitas");
        listPengukuran.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPengukuran.setInitWidths("40,170,170,170,180,180,180,60,0");
        listPengukuran.setColAlign("left,left,left,left,left,left,left,center,center");
        listPengukuran.setColTypes("ro,ro,ro,ro,ro,ro,ro,ch,ro");
        ...
        listPengukuran.enablePaging(true, 20, 10, "pagePengukuran", true);
    }
    ...
    function doOnCheck(rowId, cellInd, state) {
       ...
       if (state == 0) {
	    ...
	    + "&sm=E"
	    + "&param1=A"
        + "&param2=" + listPengukuran.cells(rowId, 0).getValue()
        + "&param4=" + listPengukuran.cells(rowId, 1).getValue()
        + "&param5=" + txtTglPengukuran.value        
        + "&param19="
        + "&param20=" + listPengukuran.cells(rowId, 7).getValue()
        + "";
