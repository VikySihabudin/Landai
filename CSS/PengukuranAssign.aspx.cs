...
public partial class Pages_PengukuranAssign : System.Web.UI.Page
{
    ...
    {
        query = @"SELECT GrupmnModuls,GrupmnUserId FROM GRUPMN WHERE GrupmnModuls ='PENGTO'";
        dt = getDataTable(query);
        if (dt.Rows.Count > 0)
        {
    ...
    private bool ServiceSelect(string sm)
    {
        ...
        switch (sm)
        {
            ...
            case "E":
                ...
                eSTP.save20("P_PENGTO", param1, param2, "", param4, param5, "", "", "", "", "", "", "", "", "", "", "", param17, "", param19, param20);
                    Response.End();
                    return false;
            ...
            case "L":
                ...
                ds_L = eSTP_L.List20("P_PENGTO", param1L, param2L, "", param4L, param5L, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
