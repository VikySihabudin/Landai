<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/mpBootstrap.master" AutoEventWireup="true" CodeFile="PemberkasanDuaList.aspx.cs" Inherits="Pages_PemberkasanDuaList" %>
...
<hr />
        ...
        <div class="form-group">            
            ...
            <label for="nama" class="control-label col-md-2">Date Awal</label>
             ...
             <asp:Button runat="server" ID="btnTambah" Text="Assign" class="btn btn-lg btn-success" PostBackUrl="~/Pages/PemberkasanDuaAssign.aspx"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div style=" width:100%; height:400px;">
                ...
                <div class="pagination" id="pagePemberkasanDua"></div>  
            </div>
            </div>
        </div>
</div>
...
<script type="text/javascript">
    ...
    function listPemberkasanDua() {
        ...
        listPemberkasanDua.setHeader("No,No Berkas,Parce No,Assignee,Status,Action,#cspan,#cspan");
        listPemberkasanDua.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,");
        listPemberkasanDua.setInitWidths("40,216,216,216,216,78,78,78");
        listPemberkasanDua.setColAlign("left,left,left,left,left,left,left,left");
        listPemberkasanDua.setColTypes("ro,ro,ro,ro,ro,link,link,link");
        listPemberkasanDua.init();
        listPemberkasanDua.setSkin("dhx_skyblue");
        listPemberkasanDua.setPagingSkin("bricks");
        listPemberkasanDua.setColSorting("str,str,str,str,str,str,str,str");
        listPemberkasanDua.enablePaging(true, 20, 10, "pagePemberkasanDua", true);
    }
