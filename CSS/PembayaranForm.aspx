<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="PembayaranForm.aspx.cs" Inherits="Pages_PembayaranForm" %>
        ...
        <hr class="style-four"></hr>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <input id="txtNoPembayaran" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtTglAppSectionHead" type="text" runat="server" class="form-control input-lg"  />
                    </div>
                </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <input id="txtNoRegistrasi" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtTglAppManager" type="text" runat="server" class="form-control input-lg"  />
                    </div>
                </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <input id="txtPID" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtTglDiterimaSurvey" type="text" runat="server" class="form-control input-lg"  />
                    </div>
                </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <input id="txtNoNegosiasi" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtTglAppGMEksternal" type="text" runat="server" class="form-control input-lg"  />
                    </div>
                </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <input id="txtNoVisum" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtTglAppBOD" type="text" runat="server" class="form-control input-lg"  />
                    </div>
                </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <input id="txtNoPemberkasan" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtTglAppDiterimaAccounting" type="text" runat="server" class="form-control input-lg"  />
                    </div>
                </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <asp:DropDownList ID="ddBerkas" runat="server" class="form-control input-lg">
                     </asp:DropDownList>
                    </div>
                    ...
                    <div class="col-lg-3">
                    <input id="txtJumlahp" type="text" runat="server" class="form-control input-lg"  />
                    </div>                
                </div>
            </form>
            <hr />
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                    <asp:TextBox id="txtNamaPerusahaan" type="text" onkeypress="return runScript(event)" runat="server" class="form-control input-lg" placeholder= "..."  />
                    <%--<input id="txtPerusahaan" type="text" class="form-control input-lg" runat="server" placeholder= "..."  />--%>
                    </div>
                    <div class="col-lg-3">
                    <%--<input type="button" id="btnCari" value="Cari" class="btn btn-info btn-lg" />--%>
                        <input type="button" id="btnCari" value="Cari"  class="btn btn-lg btn-primary" onclick="lookupIdentitas(2)" />
                    </div>
                 </div>
            </form>
            ...
            <div class="form-group">
             <label for="identitas" class="control-label col-lg-2">
                    ...
                    <div class="col-lg-3">
                    <asp:TextBox id="txtKeterangan" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control input-lg" placeholder= "..."  />
                    </div>
            </div>
            </form>
            ...
            <form role="form" class="form-horizontal">
                <div class="form-group">
                    <asp:Label ID="LEksepsi" for="identitas"  class="control-label col-lg-2" runat="server" Text="Eksepsi" Font-Bold="True"></asp:Label>
                    
                    <div class="col-lg-3">
                    <asp:CheckBox ID="chkEksepsi" runat="server" CssClass="form-control checkbox-lg"  onclick="validasi()"/>
                    </div>
                
                    <asp:Label ID="LKEksepsi" for="identitas"  class="control-label col-lg-2" runat="server" Text="Keterangan Eksepsi" Font-Bold="True"></asp:Label>
                    <div class="col-lg-3">
                    <asp:TextBox id="txtKetEks" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control input-lg" placeholder= "..."  />
                    </div>
                </div>
            </form>
...
//                alert('x');
          ...
          //txtjumlahp.value = b[12]; // Belum Ada Fieldnya Di Negosiasi
        }
    }
