...
<hr />
        ...
        <div class="form-group">            
            ...
            <div class="form-group">
    <div class="col-lg-12"><div id="gridUserManagement" style=" width:100%; height:20em; background-color:white; border: 1px solid #A4BED4"></div>
...
<script type="text/javascript">
    ...
    function ListUserManagement() {
        ...
        ListUserManagement.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter");
