...
public partial class Pages_PemberkasanSatuForm : System.Web.UI.Page
{
    ...
    {
        query = @"SELECT codessCodess, codessDescs1 FROM landcomp.CODESS WHERE codessHeadss=4
    ...
    {
        query = @"SELECT codessCodess, codessDescs1 FROM landcomp.CODESS WHERE codessHeadss=26
                AND codessStatss = 1 ORDER BY codessCodess DESC";
        dt = getDataTable(query);
        if (dt.Rows.Count > 0)
        {
  ...
  public void group()
    ...
    private bool ServiceSelect(string sm)
    {
        ...
        switch (sm)
        {
            case "V":
                ...
                ds = eSTP.List14("P_BERKS1", Param1, Param2, "", "", "", "", "", "", "", "", "", "", "", "");
            ...
            case "DOCpic":
                ...
                dsx = eSTPx.List5("P_BERKS1_D", param1, IDPemberkasan, "", "", "");
    ...
    private String Save()
    {
        ...
        try
        {
            ...
            if (output == "E" || output == "D" || output == "A")
            {
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                ds = eSTP.List14("P_BERKS1", "X", param2, "", "", "", "", "", "", "", "", "", "", "", "");
                dt = ds.Tables[0];
            ...
            if (output == "I" ||  output == "E" || output == "D")
            {
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                eSTP.save14("P_BERKS1", param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14);
    ...
    private String SaveUploadPemberkasan()
    {
        ...
        eSTP.save5("P_BERKS1_D", param1, IDPemberkasan, "", param5, _stKeterangan);
