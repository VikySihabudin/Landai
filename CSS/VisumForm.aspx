<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="VisumForm.aspx.cs" Inherits="Pages_VisumForm" %>
...
<h2>Visum</h2>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Visum</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoVisum" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

     <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Regristasi</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoRegistrasi" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
		
        </div>
    </div>
      <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No PID</label>
            <div class="col-lg-3"><asp:TextBox id="txtPID" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Temuan Objek Lahan</label>
            <div class="col-lg-3"><asp:DropDownList ID="ddTemObLah" class="form-control input-lg" runat="server"></asp:DropDownList></div>
            <label for="identitas" class="control-label col-lg-1">Keterangan</label>
            <div class="col-lg-3"><asp:TextBox id="txtOKeterangan" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
            <div class="col-lg-3"><input type="button" id="btnTambahObjek" value="Add"  class="btn btn-info btn-lg" onclick="btnAdd(this)" /></div>
        </div>
    </div>
    ...
    <br />
     ...
     <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Temuan Subjek Lahan</label>
            <div class="col-lg-3"><asp:DropDownList ID="ddTemSuLah" class="form-control input-lg" runat="server"></asp:DropDownList></div>
            <label for="identitas" class="control-label col-lg-1">Keterangan</label>
            <div class="col-lg-3"><asp:TextBox id="txtKeteranganSubjek" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
            <div class="col-lg-3"><input type="button" id="btnTambahSubjek" value="Add"  class="btn btn-info btn-lg" onclick="btnAdd(this)" /></div>
        </div>
    </div>
    ...
    <br />
         ...
         <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Temuan Documents Control</label>
            <div class="col-lg-3"><asp:DropDownList ID="ddDocum" class="form-control input-lg" runat="server"></asp:DropDownList></div>
            <label for="identitas" class="control-label col-lg-1">Keterangan</label>
            <div class="col-lg-3"><asp:TextBox id="txtKetDoc" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
            <div class="col-lg-3"><input type="button" id="BtnDoc" value="Add"  class="btn btn-info btn-lg" onclick="btnAdd(this)" /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:DropDownList ID="ddLanjut" runat="server" class="form-control"></asp:DropDownList></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-3">
            <asp:CheckBox ID="cbEksepsi" runat="server" CssClass="form-control checkbox-lg" Text="" onclick="validasi()"/>
            </div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-3"> <asp:TextBox id="txtKetEks" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
        </div>
    </div>
...
<div role="form" class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="Label1" for="identitas"  class="control-label col-lg-2" runat="server" Text="No Visums" Font-Bold="True"></asp:Label>
        <div class="col-sm-4">
            <asp:TextBox ID="txtnovi" class="form-control input-lg" runat="server" Enabled="False"></asp:TextBox>
        </div>

        <asp:Label ID="Label3" for="identitas"  class="control-label col-lg-2" runat="server" Text="Objek/Subjek Lahan" Font-Bold="True"></asp:Label>
        <div class="col-sm-4">
            <asp:TextBox ID="txtlahan" class="form-control input-lg" runat="server" Enabled="False"></asp:TextBox>
        </div>
    ...
    <div class="hidden">
       <div class="form-group">
        <asp:Label ID="Label2" for="identitas"  class="control-label col-lg-2" runat="server" Text="No Sequen" Font-Bold="True"></asp:Label>
        <div class="col-sm-4">
            <asp:TextBox ID="txtsequ" class="form-control input-lg" runat="server" Enabled="False"></asp:TextBox>
        </div>

        <asp:Label ID="Label6" for="identitas"  class="control-label col-lg-2" runat="server" Text="Jenis" Font-Bold="True"></asp:Label>
        <div class="col-sm-4">
            <asp:TextBox ID="txtjen" class="form-control input-lg" runat="server" Enabled="False"></asp:TextBox>
       </div>
     </div>
     </div>
    ...
    <div class="form-group">
        <asp:Label ID="Label4" for="identitas"  class="control-label col-lg-2" runat="server" Text="Rekomendasi" Font-Bold="True"></asp:Label>
        <div class="col-sm-4">
            <asp:TextBox ID="txtKet" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" ></asp:TextBox>
        </div>

        <asp:Label ID="Label5" for="identitas"  class="control-label col-lg-2" runat="server" Text="Aksi" Font-Bold="True"></asp:Label>
        <div class="col-sm-4">
            <asp:DropDownList ID="ddAksi" runat="server" class="form-control input-lg"></asp:DropDownList>
...
<div role="form" class="form-horizontal">
    <div class="form-group">
        <div class="col-lg-11" align="right">
            <input type="button" id="PopupbtnSaveRek" value="Save" runat="server" class="btn btn-lg btn-default" onclick="SaveKondisiRek()" />
        </div>
    </div>
</div>
</div>
...
//            txtRKeterangan.value = b[7];
    ...
    function onRowSelected1(rowId, cellIndex) {
        ...
        txtsequ.value = listVerifikasiObj.cells(rowId, 4).getValue();
        txtlahan.value = listVerifikasiObj.cells(rowId, 1).getValue();
        txtKet.value = listVerifikasiObj.cells(rowId, 2).getValue();
        txtjen.value = "21";
//      alert('a');
    ...
    function onRowSelected2(rowId, cellIndex) {
        txtnovi.value = txtNoVisum.value;
        txtsequ.value = listVerifikasiSbj.cells(rowId, 4).getValue();
        txtlahan.value = listVerifikasiSbj.cells(rowId, 1).getValue();
        txtKet.value = listVerifikasiSbj.cells(rowId, 2).getValue();
        txtjen.value = "22";
        //      alert('a');
        $("#dialogrek").dialog("open");
    ...
    function onRowSelected3(rowId, cellIndex) {
        txtnovi.value = txtNoVisum.value;
        txtsequ.value = listVerifikasiDoc.cells(rowId, 4).getValue();
        txtlahan.value = listVerifikasiDoc.cells(rowId, 1).getValue();
        txtKet.value = listVerifikasiDoc.cells(rowId, 2).getValue();
        txtjen.value = "23";
        //      alert('a');
        $("#dialogrek").dialog("open");
    ...
    function listVerifikasiObj() {
        ...
        listVerifikasiObj.setHeader("No,Kepastian Objek Lahan,Rekomendasi,Aksi,Squen");
        listVerifikasiObj.setInitWidths("40,185,135,100,0");
        listVerifikasiObj.setColAlign("left,left,left,left,left");
        listVerifikasiObj.setColTypes("ro,ro,ro,ro,ro");
        ...
        listVerifikasiObj.setColSorting("str,str,str,str,str");
    }
    ...
    function listVerifikasiSbj() {
        ...
        listVerifikasiSbj.setHeader("No,Kepastian Subjek Lahan,Rekomendasi,Aksi,Squen");
        listVerifikasiSbj.setInitWidths("40,180,135,100,0");
        listVerifikasiSbj.setColAlign("left,left,left,left,left");
        listVerifikasiSbj.setColTypes("ro,ro,ro,ro,ro");
        ...
        listVerifikasiSbj.setColSorting("str,str,str,str,str");
    }
    ...
    function listVerifikasiDoc() {
        ...
        listVerifikasiDoc.setHeader("No,Kepastian Documents,Rekomendasi,Aksi,Squen");
        listVerifikasiDoc.setInitWidths("40,180,135,100,0");
        listVerifikasiDoc.setColAlign("left,left,left,left,left");
        listVerifikasiDoc.setColTypes("ro,ro,ro,ro,ro");
        ...
        listVerifikasiDoc.setColSorting("str,str,str,str,str");
    }
    ...
    function listDoc() {
        ...
        listDoc.setHeader("No,Temuan Documents ,Keterangan,Hapus");
        listDoc.setInitWidths("40,400,400,100");
        listDoc.setColAlign("left,left,left,left");
        listDoc.setColTypes("ro,ro,ro,link");
        listDoc.init();
