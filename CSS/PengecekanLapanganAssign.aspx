<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/mpBootstrap.master" AutoEventWireup="true" CodeFile="PengecekanLapanganAssign.aspx.cs" Inherits="Pages_PengecekanLapanganAssign" %>
...
<hr />
      ...
      <div class="form-group">
        ...
        <label for="identitas" class="control-label col-md-2">Jadwal Tanggal Pengukuran</label>
        <div class="col-md-2"><asp:TextBox id="txtTglPenLap" type="text" runat="server" class="form-control" /></div>
        <label for="identitas" class="control-label col-sm-1"></label>
        <div class="col-sm-3"></div>
        <div class="col-md-1"><asp:Button runat="server" id="a" Text="Back" class="btn btn-lg btn-success" PostBackUrl="~/Pages/PengecekanLapanganList.aspx" /></div>    
      </div>
...
//    var newUrl = "PraRegistrasiForm.aspx";
   ...
   // listPengecekanLapangan.loadXML("../xml/2_PengecekanLapangan.xml");
    ...
    function listPengecekanLapangan() {
        ...
        listPengecekanLapangan.setHeader("No,Nomor PL,Nomor PR,Nama,Kecamatan,Desa,Assign,Action");
        listPengecekanLapangan.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPengecekanLapangan.setInitWidths("40,181,181,181,181,181,130,60");
        listPengecekanLapangan.setColAlign("left,left,left,left,left,left,left,left");
        listPengecekanLapangan.setColTypes("ro,ro,ro,ro,ro,ro,ro,ch");
        ...
        listPengecekanLapangan.setColSorting("str,str,str,str,str,str,str,str");
    ...
    function doOnCheck(rowId, cellInd, state) {
	    ...
	    + "&sm=E"
	    + "&param1=A"
        + "&param2=" + listPengecekanLapangan.cells(rowId, 0).getValue()
        + "&param6=" + listPengecekanLapangan.cells(rowId, 1).getValue()
        + "&param13="
