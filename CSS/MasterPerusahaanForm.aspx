...
<h1>Master Perusahaan</h1>
	...
	<form role="form" class="form-horizontal" action="#">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtIdPerusahaan" class="form-control" type="text" runat="server" /></div>			
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nama Perusahaan</label>
            <div class="col-lg-3"><asp:TextBox id="txtNamaPerusahaan" class="form-control" type="text" runat="server" /></div>			
        </div>
