...
public partial class Pages_PengecekanLapanganForm : System.Web.UI.Page
{
    ...
    private String Save()
    {
        ...
        try
        {
            ...
            if (output == "E" || output == "D" || output == "A")
            {
                ...
                eSTP.save13("P_PENLAP", param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13);
    ...
    private String SaveUploadPengecekan()
    {
        ...
        eSTP.save5("P_PENLAP_D", param1, IDPengecekan, "", param5, _stKeterangan);
