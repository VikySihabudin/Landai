...
<hr />
        ...
        <div class="form-group">
            ...
            <div style=" width:100%; height:400px;">
                ...
                <div class="pagination" id="pageNegosiasi"></div> 
            </div>
            </div>
        </div>
</div>
...
<script type="text/javascript">
    ...
    function listNegosiasi() {
        ...
        listNegosiasi.enablePaging(true, 20, 10, "pageNegosiasi", true);
    }
    ...
    function doOnCheck(rowId, cellInd, state) {
	    ...
	    + "&sm=E"
	    + "&param1=A"
        + "&param2=" + listNegosiasi.cells(rowId, 0).getValue()
        + "&param4=" + listNegosiasi.cells(rowId, 1).getValue()
        + "&param5=" + listNegosiasi.cells(rowId, 2).getValue()
        + "&param11="
        + "";
