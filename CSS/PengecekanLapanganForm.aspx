<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="PengecekanLapanganForm.aspx.cs" Inherits="Pages_PengecekanLapanganForm" %>
...
<h1>Pengecekan Lapangan</h1>
	...
	<div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtNoPL" type="text" runat="server" class="form-control" /></div>			
            <label for="nama" class="control-label col-md-3">Tanggal Jadwal Pengukuran</label>
            <div class="col-lg-3">
            <asp:TextBox id="txtTgljadwalPengukuran" type="text" runat="server" class="form-control" />
            </div>
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Tanggal Pengecekan</label>
            <div class="col-lg-3"><asp:TextBox id="txtTglPengukuran" class="form-control" type="text" runat="server" /></div>			
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nomor PR</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoPR" type="text" runat="server" class="form-control" placeholder= "..." /></div>			
        </div>

        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">Nama Penjual</label>
            <div class="col-lg-3"><asp:TextBox id="txtNamaPenjual" type="text" runat="server" class="form-control" placeholder= "..." /></div>			
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3">
               <%--<asp:TextBox id="ddKabupaten" type="text" runat="server" class="form-control input-lg" />--%>
               <asp:DropDownList ID="ddKabupaten" type="text" runat="server" class="form-control input-lg"></asp:DropDownList>
            </div>
            <div class="col-lg-3">
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">            
            <div class="col-md-4"><asp:DropDownList ID="ddJenis" class="form-control input-lg" runat="server"></asp:DropDownList></div>
            <label for="identitas" class="control-label col-md-1">Keterangan</label>
            <div class="col-md-3"><asp:TextBox id="txtKeteranganJenis" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
                    <div class="col-lg-3">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3">
                <asp:DropDownList ID="ddLanjut" runat="server" class="form-control"></asp:DropDownList>
            </div>
        </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:CheckBox ID="cbEksepsi" CssClass="form-control checkbox-lg" runat="server" onclick="validasi()" /> </div>
        </div>
        </div>
        ...
        <asp:Label ID="LKEksepsi" for="identitas"  class="control-label col-lg-2" runat="server" Text="Keterangan Ekspesi" Font-Bold="True"></asp:Label>
            <div class="col-lg-3"><asp:TextBox id="txtKetEksepsi" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control" placeholder= "..." /></div>
        </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtKeterangan" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control" placeholder= "..." /></div>
        </div>
        </div>
    ...
    function outputResponse(loader) {
        ...
        switch (b[0]) {
            ...
            case "D":
                ...
                break;
            case "nodelete":
                alert("Data Pengukuran T0 Tidak Dapat Di Hapus Karena Sudah Dilakukan Verifikasi");
                //window.location.replace(newUrl);
                close();
                break;
            case "noedit":
                alert("Data Pengukuran T0 Tidak Dapat Di Edit Karena Sudah Dilakukan Verifikasi");
                //window.location.replace(newUrl);
                close();
                break;
            case "noadd":
                alert("Data Pengukuran T0 Tidak Dapat Di Assign Karena Sudah Dilakukan Verifikasi");
                //window.location.replace(newUrl);
                close();
                break;
            case "gagal":
