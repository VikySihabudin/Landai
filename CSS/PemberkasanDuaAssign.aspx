...
<script type="text/javascript">
    ...
    function listPemberkasanDua() {
        ...
        listPemberkasanDua.setHeader("No,No Berkas,Parce No,Assignee,Status,Action,1,2,3,4,5");
        listPemberkasanDua.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPemberkasanDua.setInitWidths("40,250,250,250,250,100,0,0,0,0,0");
        listPemberkasanDua.setColAlign("left,left,left,left,left,left,left,left,left,left,left");
        listPemberkasanDua.setColTypes("ro,ro,ro,ro,ro,ch,ro,ro,ro,ro,ro");
    ...
    function doOnCheck(rowId, cellInd, state) {
	    ...
	    + "&sm=E"
	    + "&param1=A"
        + "&param2=" + listPemberkasanDua.cells(rowId, 0).getValue()
        + "&param4=" + listPemberkasanDua.cells(rowId, 9).getValue()
        + "&param5=" + listPemberkasanDua.cells(rowId, 1).getValue()
        + "&param6=" + listPemberkasanDua.cells(rowId, 5).getValue()
        + "&param7=" + listPemberkasanDua.cells(rowId, 6).getValue()
        + "&param8=" + listPemberkasanDua.cells(rowId, 7).getValue()
        + "&param9=" + listPemberkasanDua.cells(rowId, 8).getValue()
        + "&param15=" 
        + "";
