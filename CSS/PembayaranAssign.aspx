...
<hr />
        ...
        <div class="form-group">
            ...
            <div style=" width:100%; height:400px;">
             ...
             <div class="pagination" id="pagePembayaran"></div>  
            </div>
            </div>
        </div>
</div>
...
<script type="text/javascript">
    ...
    function listPembayaran() {
        ...
        listPembayaran.setHeader("No,No Pembayaran,Parce No,Assignee,Status,Action,1,2,3,4,5");
        listPembayaran.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPembayaran.setInitWidths("40,280,280,220,220,80,0,0,0,0,0");
        listPembayaran.setColAlign("left,left,left,left,left,leftleft,left,left,left,left");
        listPembayaran.setColTypes("ro,ro,ro,ro,ro,ch,ro,ro,ro,ro,ro");
        ...
        listPembayaran.enablePaging(true, 20, 10, "pagePembayaran", true);
    }
...
//        alert(listPembayaran.cells(rowId, 0).getValue());
	    ...
	    + "&sm=E"
	    + "&param1=A"
        + "&param2=" + listPembayaran.cells(rowId, 0).getValue()
        + "&param4=" + listPembayaran.cells(rowId, 5).getValue()
        + "&param5=" + listPembayaran.cells(rowId, 6).getValue()
        + "&param6=" + listPembayaran.cells(rowId, 7).getValue()
        + "&param7=" + listPembayaran.cells(rowId, 8).getValue()
        + "&param8=" + listPembayaran.cells(rowId, 9).getValue()
        + "&param21=" 
        + "";
