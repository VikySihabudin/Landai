...
<h2>Pengukuran</h2><br />
    ...
    <div role="form" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-3">
                <asp:TextBox ID="txtLuasOverlap" class="form-control input-lg" runat="server"></asp:TextBox>
            </div>
            </div>
        <div class="form-group">
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <div class="col-lg-11" align="right">
                <input type="button" id="PopupbtnSaveKondisiLahan" value="Save" runat="server" class="btn btn-lg btn-default" onclick="SaveOverlap()" />
            </div>
        </div>
    </div>
    </div>
