...
//    listPembayaran.loadXML("../xml/1_Pembayaran.xml");
    function listPembayaran() {
        ...
        listPembayaran.setHeader("No,No Pembayaran,Parce No,Assignee,Status,Action,#cspan,#cspan");
        listPembayaran.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,");
        listPembayaran.setInitWidths("40,250,250,220,182,65,65,65")
        listPembayaran.setColAlign("left,left,left,left,left,left,left");
        listPembayaran.setColTypes("ro,ro,ro,ro,ro,link,link,link");
        listPembayaran.init();
