<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MPForm.master" CodeFile="R_PraNegosiasi.aspx.cs" Inherits="Pages_R_PraNegosiasi" %>
...
<script type="text/javascript">
    ...
    function btnClick(btn) {
        ...
        //alert('S');
        var url = "http://192.168.0.57/landcomp/report/r007.aspx";
