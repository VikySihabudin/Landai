<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/mpBootstrap.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Pages_Home" %>
    ...
    <span id="chartdiv4">January Column 2D Chart will load here</span>
                    ...
                    <br />
                            ...
                            <div style=" width:100%; height:300px;">
                                    ...
                                    <div class="pagination" id="pagehome"> </div>
                            </div>
                            </div>
...
<link href="../CSS/page.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript"><!--
        ...
        function listHome() {
            ...
            listHome.setHeader("No,Nama,No Registrasi,No Pengukuran T0,No Negosiasi,No Verifikasi,No Pemberkasan,No Pembayaran,No Finalisasi");
            ...
            listHome.enablePaging(true, 20, 10, "pagehome", true);
        }
