...
<div class="form-group"> 
    ...
    <div class="form-group"> 
        <div class="col-lg-12" style=" width:100%; height:400px;">
         ...
         <div class="pagination" id="pageGroup"></div>      
...
<script type="text/javascript">
    ...
    function listGroupManagement() {
        ...
        listGroupManagement.setHeader("1, Group Name,Group Lanjut,Group Except,Action,#cspan,#cspan,#cspan");
        listGroupManagement.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter");
        listGroupManagement.setInitWidths("0,226,226,226,62,62");
        listGroupManagement.setColAlign("left,left,left,left,center");
        listGroupManagement.setColTypes("ro,ro,ro,ro,link,link,link");
        listGroupManagement.init();
        listGroupManagement.setSkin("dhx_skyblue");
        listGroupManagement.setPagingSkin("bricks");
        listGroupManagement.setColSorting("str,str,str,str");
        listGroupManagement.enablePaging(true, 20, 10, "pageGroup", true);
    }
