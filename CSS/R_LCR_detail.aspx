<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MPForm.master" CodeFile="R_LCR_detail.aspx.cs" Inherits="Pages_R_LCR_detail" %>
...
<div class="container">
<center>
    <h2>LAND COMPENSATION REPORT DETAIL</h2>
</center>
...
<script type="text/javascript">
    ...
    function btnClick(btn) {
        ...
        //alert('S');
        var url = "http://localhost/landcomp/report/r011.aspx";
