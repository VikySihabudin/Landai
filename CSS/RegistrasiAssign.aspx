<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/mpBootstrap.master" AutoEventWireup="true" CodeFile="RegistrasiAssign.aspx.cs" Inherits="Pages_RegistrasiAssign" %>
...
<hr />
        <div class="form-group">            
			...
			<div class="col-lg-10" align="right">
                ...
                <asp:Button runat="server" id="btnBack" Text="Back" class="btn btn-lg btn-success" PostBackUrl="~/Pages/RegistrasiList.aspx" />   
        </div>
        </div>
...
<script type="text/javascript">
    ...
    function listRegistrasi() {
        ...
        listRegistrasi.setHeader("No,No Registrasi,No PL,Nama,Kecamatan,Desa,Assign,Action,Mident");
        listRegistrasi.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listRegistrasi.setInitWidths("40,161,161,161,161,161,171,100,0");
        listRegistrasi.setColAlign("left,left,left,left,left,left,left,left,left");
        listRegistrasi.setColTypes("ro,ro,ro,ro,ro,ro,ro,ch,ro");
    ...
    function doOnCheck(rowId, cellInd, state) {
	    ...
	    + "&sm=E"
	    + "&param1=A"
        + "&param2=" + listRegistrasi.cells(rowId, 0).getValue()
        + "&param4=" + listRegistrasi.cells(rowId, 1).getValue()
        + "&param34="
        + "&param5=" + listRegistrasi.cells(rowId, 7).getValue()
        + "";
