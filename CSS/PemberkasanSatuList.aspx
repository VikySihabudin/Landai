...
<script type="text/javascript">
   ...
   // listPemberkasan.loadXML("../xml/1_Pemberkasan.xml");
    function listPemberkasan() {
        ...
        listPemberkasan.setHeader("No,No Berkas,No Negosiasi,No Visum,Assignee,Action,#cspan,#cspan");
        listPemberkasan.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,");
