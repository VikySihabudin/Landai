<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="PemberkasanDuaForm.aspx.cs" Inherits="Pages_PemberkasanDuaForm" %>
...
<h2>Finalisasi</h2>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Finalisasi</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoPemberkasanDua" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
            <label for="identitas" class="control-label col-lg-2">No Penyimpanan</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoPenyimpanan" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Registrasi</label>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Negosiasi</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoNegosiasi" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Pemberkasan</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoPemberkasanSatu" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>

    <div role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Pembayaran</label>
            <div class="col-lg-3"><asp:TextBox id="txtNoPembayaran" type="text" runat="server" class="form-control input-lg" placeholder= "..." /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">            
            <div class="col-md-3"><asp:DropDownList ID="ddProsesPembayaran" class="form-control input-lg" runat="server"></asp:DropDownList></div>
            <label for="identitas" class="control-label col-md-1">Keterangan</label>
            <div class="col-md-3"><asp:TextBox id="txtKeteranganPembayaran" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
                    <div class="col-lg-3">
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:CheckBox ID="chkEksepsi" runat="server" CssClass="form-control checkbox-lg" Text="Ya"  onclick="validasi()" /></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="form-group">
            <asp:Label  ID="LSelesai" runat="server"  for="identitas" class="control-label col-lg-2"  Text="Selesai" Font-Bold="True"></asp:Label>
            <div class="col-lg-3"><asp:DropDownList ID="ddLSelesai" runat="server" class="form-control input-lg">
    ...
    function outputResponse(loader) {
        ...
        switch (b[0]) {
            ...
            case "D":
                ...
                break;
            case "nodelete":
                alert("Data Finalisasi Tidak Dapat Di Hapus Karena Sudah Dilakukan Pembayaran");
                //                window.location.replace(newUrl);
                close();
                break;
            case "noedit":
                alert("Data Finalisasi Tidak Dapat Di Edit Karena Sudah Dilakukan Pembayaran");
                //                window.location.replace(newUrl);
                close();
                break;
            case "gagal":
