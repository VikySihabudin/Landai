<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="RegistrasiForm.aspx.cs" Inherits="Pages_RegistrasiForm" %>
...
<h1>Registrasi</h1>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtAlamat" TextMode="multiline" Columns="15" Rows="3" runat="server" class="form-control" placeholder= "..." /></div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:DropDownList ID="ddTandaIdentitas" class="form-control" runat="server"></asp:DropDownList></div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtNoHandphone" type="text" runat="server" class="form-control" placeholder= "..." /></div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtNamaPasangan" type="text" runat="server" class="form-control" placeholder= "..." /></div>			
        </div>
    </div>
     ...
     <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox id="txtTahunMenikah" type="text" runat="server" class="form-control" placeholder= "..." /></div>			
        </div>
    </div>
 ...
 <hr />
     ...
     <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3">
                <asp:DropDownList ID="DDQuest1" class="form-control" runat="server">
                </asp:DropDownList>
                <br />
                <input id="txtBerapaKaliQuest1" type="text" runat="server" class="form-control" placeholder="..." />
            </div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3">
                <asp:DropDownList ID="ddQuest2" class="form-control" runat="server">
                </asp:DropDownList>
                <br />
                <input id="txtBerapaKaliQuest2" type="text" runat="server" class="form-control" placeholder="..." />
            </div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal">
        <div class="col-lg-13">            
            ...
            <div class="col-lg-2"><asp:DropDownList ID="ddSHM" class="form-control" runat="server"></asp:DropDownList></div>
            <label for="identitas" class="control-label col-sm-2">Nomor</label>
            <div class="col-sm-2"><asp:TextBox id="txtShmNomor" type="text" runat="server" class="form-control" placeholder= "..." /></div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            <div class="col-lg-2"><asp:DropDownList ID="ddPerolehanLahan" class="form-control" runat="server" onChange="javascript:DDKelengkapan()"></asp:DropDownList></div>
            <div class="col-lg-3"><asp:DropDownList ID="ddKelengkapan" class="form-control" runat="server"></asp:DropDownList></div>
            <div class="col-lg-3">
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3"><asp:TextBox ID="txtLuasLahan" class="form-control input-lg" runat="server"></asp:TextBox></div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-2"><asp:TextBox ID="txtBatasUtara" class="form-control input-lg" runat="server"></asp:TextBox></div>
            <label for="identitas" class="control-label col-lg-1">Selatan</label>		
            <div class="col-lg-2"><asp:TextBox ID="txtBatasSelatan" class="form-control input-lg" runat="server"></asp:TextBox></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-2"><asp:TextBox ID="txtBatasTimur" class="form-control input-lg" runat="server"></asp:TextBox></div>
            <label for="identitas" class="control-label col-lg-1">Barat</label>		
            <div class="col-lg-2"><asp:TextBox ID="txtBatasBarat" class="form-control input-lg" runat="server"></asp:TextBox></div>
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3">
               <asp:DropDownList ID="ddSengketa" class="form-control" runat="server">
                </asp:DropDownList>
                <br />
                <input id="txtPernahSengketa" type="text" runat="server" class="form-control input-lg" placeholder="..." />
            </div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3">
               <asp:DropDownList ID="ddDiagunkan" class="form-control" runat="server">
                </asp:DropDownList>
                <br />
                <input id="txtPernahDiagunkan" type="text" runat="server" class="form-control input-lg" placeholder="..." />
            </div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        <div class="form-group">
            ...
            <div class="col-lg-3">
               <asp:DropDownList ID="DDPecahanAlasHak" class="form-control" runat="server">
                </asp:DropDownList>
                <br />
                <input id="txtTahunPecahanAlasHak" type="text" runat="server" class="form-control input-lg" placeholder="..." />
            </div>			
        </div>
    </div>
    ...
    <div role="form" class="form-horizontal" action="#">
        ...
        <%--<label for="identitas" class="control-label col-lg-2">Lanjut</label>--%>
         <asp:Label ID="LLanjut" for="identitas"  class="control-label col-lg-2" runat="server" Text="Lanjut" Font-Bold="True"></asp:Label>
            <div class="col-lg-3">
                <asp:DropDownList ID="ddLanjut" class="form-control" runat="server">
                </asp:DropDownList> 
            </div>
