...
<script type="text/javascript">
    ...
    function ListVisum() {
        ...
        ListVisum.setHeader("No,No Visum,No Registrasi,PID,Assigne,Status,Nama Penjual,Nama PLK,Action,#cspan,#cspan");
        ListVisum.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        ListVisum.setInitWidths("40,132,132,132,132,132,156,156,40,40,40");
        ListVisum.setColAlign("left,left,left,left,left,left,left,left,left,left,left");
        ListVisum.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,link,link,link");
        ListVisum.init();
        ListVisum.setSkin("dhx_skyblue");

        ListVisum.setColSorting("str,str,str,str,str,str,str,str,str,str,str");
