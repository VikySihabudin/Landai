...
<script type="text/javascript">
    ...
    function listPemberkasanDua() {
        ...
        listPemberkasanDua.setHeader("No,No Berkas,No registrasi,No Pid,Assignee,Status,Nama Penjual,Action,#cspan,#cspan");
        listPemberkasanDua.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listPemberkasanDua.setInitWidths("40,145,145,145,145,145,145,78,78,78");
        listPemberkasanDua.setColAlign("left,left,left,left,left,left,left,left,left,left");
        listPemberkasanDua.setColTypes("ed,ed,ed,ed,ed,ed,ed,link,link,link");
        listPemberkasanDua.init();
        listPemberkasanDua.setSkin("dhx_skyblue");

        listPemberkasanDua.setColSorting("str,str,str,str,str,str,str,str,str");
