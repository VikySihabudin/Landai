<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPForm.master" AutoEventWireup="true" CodeFile="PemberkasanSatuForm.aspx.cs" Inherits="Pages_PemberkasanSatuForm" %>
...
<h2>Pemberkasan</h2>
    ...
    <form role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-2">No Negoisasi</label>
    ...
    <form role="form" class="form-horizontal">
        ...
        <form role="form" class="form-horizontal">
        <div class="form-group">
            <label for="identitas" class="control-label col-lg-3">Perolehan Lahan</label>
            
            <label for="identitas" class="control-label col-lg-3">Keterangan</label>
           
            <label for="identitas" class="control-label col-lg-3">Upload file</label>
    ...
    <form role="form" class="form-horizontal">
        <div class="form-group">            
            <div class="col-lg-3"><asp:DropDownList ID="ddPerolehanLahan" class="form-control input-lg" runat="server"></asp:DropDownList></div>
            <div class="col-lg-3"><asp:TextBox id="txtPerLahKet" class="form-control input-lg" TextMode="multiline" Columns="15" Rows="3" runat="server" /></div>
            <div class="col-lg-3">
    ...
    <form role="form" class="form-horizontal">
        <div class="form-group">
            <label  ID="LKeterangan"for="identitas" class="control-label col-lg-2">Keterangan</label>
