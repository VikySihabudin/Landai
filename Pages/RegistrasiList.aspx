...
<script type="text/javascript">
 ...
 // listRegistrasi.loadXML("../xml/1_Registrasi.xml");
    function listRegistrasi() {
        ...
        listRegistrasi.setHeader("No,No Pra Registrasi,No Registrasi,No Pengecekan Lapangan,Assignee,Status,Nama Penjual,Action,#cspan,#cspan");
        listRegistrasi.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listRegistrasi.setInitWidths("50,150,160,160,110,130,140,76,76,76");
        listRegistrasi.setColAlign("left,left,left,left,left,left,left,left,left,left");
        listRegistrasi.setColTypes("ed,ed,ed,ed,ed,ed,ed,link,link,link");
        listRegistrasi.init();
