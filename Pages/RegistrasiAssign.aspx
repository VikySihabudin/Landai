...
<script type="text/javascript">
    ...
    function listRegistrasi() {
        ...
        listRegistrasi.setHeader("No,No Registrasi,No PL,Nama Penjual,Kecamatan,Desa,Assign,Action,Mident");
        ...
        listRegistrasi.setColTypes("ed,ed,ed,ed,ed,ed,ed,ch,ed");
    ...
    function doOnCheck(rowId, cellInd, state) {
        ...
        + "&param34="
        + "&param5=" + listRegistrasi.cells(rowId, 8).getValue()
        + "";
