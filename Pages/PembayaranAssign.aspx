...
<script type="text/javascript">
    ...
    function listPembayaran() {
        ...
        listPembayaran.setHeader("No,No Pembayaran,No Registrasi,No Pid,Assignee,Status,Nama Penjual,Action,No PID,No Negosiasi,No Visums,No Pemberkasan");
        listPembayaran.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listPembayaran.setInitWidths("40,170,170,170,170,170,170,80,0,0,0,0");
        listPembayaran.setColAlign("left,left,left,left,left,left,leftleft,left,left,left,left");
        listPembayaran.setColTypes("ed,ed,ed,ed,ed,ed,ed,ch,ed,ed,ed,ed,ed");
        listPembayaran.attachEvent("onCheckbox", doOnCheck);
        listPembayaran.init();
        listPembayaran.setSkin("dhx_skyblue");

        listPembayaran.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str");
...
//        alert(listPembayaran.cells(rowId, 0).getValue());
        ...
        + "&param5=" + listPembayaran.cells(rowId, 8).getValue() // No Pid
        + "&param6=" + listPembayaran.cells(rowId, 9).getValue() // No Negosiasi
        + "&param7=" + listPembayaran.cells(rowId, 10).getValue() // No Visums
        + "&param8=" + listPembayaran.cells(rowId, 11).getValue() // No Pemberkasan
        + "&param21=" 
        + "";
