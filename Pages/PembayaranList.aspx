...
//    listPembayaran.loadXML("../xml/1_Pembayaran.xml");
    function listPembayaran() {
        ...
        listPembayaran.setHeader("No,No Pembayaran,No Registrasi,No PID,Assignee,Status,Nama Penjual,Action,#cspan,#cspan");
        listPembayaran.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listPembayaran.setInitWidths("40,145,145,145,145,145,170,65,65,65")
        listPembayaran.setColAlign("left,left,left,left,left,left,left,left,left");
        listPembayaran.setColTypes("ed,ed,ed,ed,ed,ed,ed,link,link,link");
        listPembayaran.init();
        listPembayaran.setSkin("dhx_skyblue");

        listPembayaran.setColSorting("str,str,str,str,str,str,str,str,str");
