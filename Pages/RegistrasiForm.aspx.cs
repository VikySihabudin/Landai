...
public partial class Pages_RegistrasiForm : System.Web.UI.Page
{
    ...
    private String Save()
    {
        ...
        try
        {
            ...
            {  
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                ds = eSTP.List34("P_REGIST", "X", param2, "","", "", "", "", "", "", "", "", "", "", "","", "", "", "", "", "", "", "", "","","","","", "", "", "","","","","");
                dt = ds.Tables[0];
            ...
            if (output == "E" || output == "D" || output == "A")
            {
                ...
                eSTP.Datas();
                DataSet ds = new DataSet();
                eSTP.save34("P_REGIST", param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18, param19, param20, param21, param22, param23, param24, param25, param26, param27, param28, param29, param30, param31, userid, param33, param34);
    ...
    private String SaveUploadKelengkapan()
    {
        ...
        if (param3=="2"){param3 = "11";}
        if (param3=="3"){param3 = "12";}
        if (param3=="4"){param3 = "13";}
