...
<script type="text/javascript">
    ...
    function listPengukuran() {
        ...
        listPengukuran.setHeader("No,PID,No Registrasi,Nama Penjual,Kecamatan,Desa,Assign,Action,No Identitas");
        ...
        listPengukuran.setColTypes("ed,ed,ed,ed,ed,ed,ed,ch,ed");
    ...
    function doOnCheck(rowId, cellInd, state) {
       ...
       if (state == 0) {
        ...
        + "&param4=" + listPengukuran.cells(rowId, 2).getValue()
        + "&param5=" + txtTglPengukuran.value
        + "&param19=" 
        + "&param20=" + listPengukuran.cells(rowId, 8).getValue()
        + "";
