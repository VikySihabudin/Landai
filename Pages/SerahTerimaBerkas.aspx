							...
							<div class="tab-pane" id="tab2">
                                ...
                                <div role="form" class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                        <asp:DropDownList ID="ddfil" runat="server" class="form-control input-lg" onclick="handleClick()">
                                        </asp:DropDownList>
                                        <div class="hidden">
                                        <asp:TextBox id="txtDiSerahkanDari" type="text" runat="server" class="form-control input-lg" placeholder= "..." />
                                        </div>
                                        </div>
                                    </div>
                                </div>
...
<link href="../CSS/page.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
     ...
     function listTerimaBerkas() {
         ...
         listTerimaBerkas.setHeader("No,No Registrasi,Nama Penjual,Nomor Identitas,No Hp,Desa,Kecamatan,Kabupaten,User Serah,User Terima,Accept,Nomer Serah Terima");
         listTerimaBerkas.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
         listTerimaBerkas.setInitWidths("30,120,120,120,100,100,100,110,120,120,70,0");
         listTerimaBerkas.setColAlign("left,left,left,left,left,left,left,left,left,left,left,left");
         listTerimaBerkas.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ed,ed,ch,ed");
         listTerimaBerkas.attachEvent("onCheckbox", doOnCheck);
         listTerimaBerkas.init();
         listTerimaBerkas.setSkin("dhx_skyblue");

         listTerimaBerkas.setColSorting("str,str,str,str,str,str,str,str,str,str,str,str");
     ...
     function doOnCheck(rowId, cellInd, state) {
         ...
         if (state == 0) {
	        ...
	        + "&sm=CRUD"
	        + "&param1=E"
            + "&param2=" + listTerimaBerkas.cells(rowId, 11).getValue()
            + "";
