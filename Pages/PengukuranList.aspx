...
<script type="text/javascript">
  ...
  //  listPengukuran.loadXML("../xml/1_Pengukuran_T0.xml");
    function listPengukuran() {
        ...
        listPengukuran.setHeader("No,PID,No Register,No Assignee,Status,Nama Penjual,Action,#cspan,#cspan");
        listPengukuran.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,,,#rspan");
        listPengukuran.setInitWidths("50,188,188,188,188,190,45,45,45");
        listPengukuran.setColAlign("left,left,left,left,left,left,left,left,left");
        listPengukuran.setColTypes("ed,ed,ed,ed,ed,ed,link,link,link");
        listPengukuran.init();
        listPengukuran.setSkin("dhx_skyblue");

        listPengukuran.setColSorting("str,str,str,str,str,str,str,str");
