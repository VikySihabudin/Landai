...
<script type="text/javascript">
    ...
    function listNegosiasi() {
        ...
        listNegosiasi.setHeader("No,No Negosiasi,No Registrasi,PID,Status,Assigne,Nama Penjual,Nama PLK,Action");
        listNegosiasi.attachHeader("#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
        listNegosiasi.setInitWidths("40,132,132,132,132,132,166,166,94");
        listNegosiasi.setColAlign("left,left,left,left,left,left,left,left,left");
        listNegosiasi.setColTypes("ed,ed,ed,ed,ed,ed,ed,ed,ch");
        listNegosiasi.attachEvent("onCheckbox", doOnCheck);
        listNegosiasi.init();
        listNegosiasi.setSkin("dhx_skyblue");

        listNegosiasi.setColSorting("str,str,str,str,str,str,str,str");
